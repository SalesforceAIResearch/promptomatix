*This is a suggested `CONTRIBUTING.md` file template for use by open sourced Salesforce projects. The main goal of this file is to make clear the intents and expectations that end-users may have regarding this project and how/if to engage with it. Adjust as needed (especially look for `promptomatix` which refers to the org and repo name of your project) and remove this paragraph before committing to your repo.*

# Contributing Guide For Promptomatix
...
-  If you find a bug, please search for it in the [Issues](https://github.com/promptomatix/issues), and if it isn't already tracked,
   [create a new issue](https://github.com/promptomatix/issues/new). Fill out the "Bug Report" section of the issue template. Even if an Issue is closed, feel free to comment and add details, it will still
   be reviewed.
...
### New Features
-  If you'd like to add new functionality to this project, describe the problem you want to solve in a [new Issue](https://github.com/promptomatix/issues/new).
...
-  If you'd like to improve the tests, you want to make the documentation clearer, you have an
  ...
  -  If not, [open an Issue](https://github.com/promptomatix/issues/new) to discuss the idea first.
